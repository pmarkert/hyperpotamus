...
var logical_handler_folder = path.join(__dirname, "logical_handlers");
...
module.exports = function(options) {
	if(!options) options = {};
	return readJsFiles(options.logical_handler_folder || logical_handler_folder).concat(
		readJsFiles(options.action_handler_folder || action_handler_folder)
	);
}
