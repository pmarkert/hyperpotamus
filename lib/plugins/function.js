...
module.exports.process = function (context, callback) {
	...
	if (func.length == 1) { // Synchronous function
		callback(func.call(this, context));
	}
	else if (func.length == 2) {
		func.call(this, context, callback);
	}
	else {
		throw new Error("Custom function has unexepcted number of arguments. Must take 1 or 2 arguments.");
	}
}
