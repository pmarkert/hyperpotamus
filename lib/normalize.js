...
module.exports = function(script, plugins) {
	...
	// TODO - Does not allow me to pass in defaults - wants to wrap and turn them into a request
	var normalized = _.isArray(script) ? script : [ script ]
	if(!normalized.defaults) { normalized.defaults = { pool : { maxSockets: Infinity } } };
