...
module.exports.process = function (context) {
	...
	var request = {};
	_.merge(request, default_useragent, _.get(context.session, "request_defaults"), this.request);
	...
	return context.httpClient(request).then(response => {
		...
		return context.processAction(response_actions)
			.catch(err => {
				if(err instanceof context.ProcessingDirective || verror.hasCauseWithName("ResponseActionError")) {
					throw err;
				}
