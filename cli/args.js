...
var args = require("yargs")
	...
	.example("$0 get_ranking.yml --csv users.csv --session.username=admin --session.password=secret'", "Equivalent to the above")
	...
	.requiresArg("qs")
	.describe("session", "Additional properties to be added to the initial session (alternative syntax to --qs)")
